...
void loop()
{
  ...
  point globalPoint = localToGlobal(accelVector);
  ...
  point localPoint = globalToLocal(globalStart);
  ...
  */
  ...
  Serial.print(globalPoint.x);
  Serial.print(", ");
  Serial.print(globalPoint.y);
  Serial.print(", ");
  Serial.print(globalPoint.z);


  Serial.print("   ,   ");


  Serial.print(localPoint.x);
  Serial.print(", ");
  Serial.print(localPoint.y);
  Serial.print(", ");
  Serial.println(localPoint.z);
...
point localToGlobal(point p)
{
  ...
  quaternion tempPoint = HProd(HProd(orient, pointQ),conj(orient));
...
point globalToLocal(point p)
{
  ...
  quaternion tempPoint = HProd(HProd(conj(orient), pointQ),orient);
...
/**
 * Takes the hamilton product of two quaternions
 */
quaternion HProd(quaternion q1, quaternion q2)
{
